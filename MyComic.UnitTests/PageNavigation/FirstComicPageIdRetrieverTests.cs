...
namespace MyComic.UnitTests.PageNavigation
{
    ...
    class FirstComicPageIdRetrieverTests
    {
        ...
        public void RetrieveFirstComicPageId_WhenThreePages_ReturnsFirstPage()
        {
            ...
            mockComicIssueByIdRetriever.Setup(cibir => cibir.GetComicIssue(It.IsAny<Guid>())).Returns(
                new ComicIssue()
                {
            ...
            IFirstComicPageIdRetriever firstComicPageIdRetriever = new FirstComicPageIdRetriever(mockComicIssueByIdRetriever.Object);
            Guid currentComicIssueId = new Guid("075b6e68-9d2f-476f-9e92-1e8e4b870f8e");

            Guid firstComicPageId = firstComicPageIdRetriever.RetrieveFirstComicPageId(currentComicIssueId);
